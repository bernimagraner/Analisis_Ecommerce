...
Analizar los datos transaccionales para intentar generar insights y crear potenciales acciones CRO que incrementen visitas, conversiones y ticket medio, y por tanto incrementar la facturación global del ecommerce.



Crear activos analíticos avanzados como una segmentación RFM, análisis de cohortes, LTV y un sistema de recomendación que impulsen la consecución del objetivo.
